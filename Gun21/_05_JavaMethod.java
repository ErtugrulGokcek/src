...
public class _05_JavaMethod {
    public static void main(String[] args) {
        ...
        int sonuc3 = toplam(s1, s2, s3, s4); // ayni bu sekilde tipleri ayni fakat sayilari farkli ise bu durumda->
        ...
        public static int toplam (int...sayilar) { // kac sayi gelirse gelsin onlari dizi seklinde aliyor
            int toplam = 0;
